...
def generate_launch_description():
    return LaunchDescription([
        ...
        _declare('hover_z_a', '0.08', 'A/attach key hover Z in base frame meters.'),
        _declare('target_z_a', '-0.07', 'A/attach key descend target Z in base frame meters.'),
        _declare('hover_z_d', '0.08', 'D/detach key hover Z in base frame meters.'),
        _declare('target_z_d', '-0.07', 'D/detach key descend target Z in base frame meters.'),
        _declare(
            'hover_z_m',
            '0.06',
            'Legacy hover Z in base frame meters; A/D clicks use hover_z_a/d.',
        ),
        _declare(
            'min_z_m',
            '0.02',
            'Legacy minimum allowed target Z for descend_distance_m mode.',
        ),
        _declare(
            'descend_distance_m',
            '0.04',
            ...
            'Final descend_z_m is clamped at min_z_m.',
        ),
        ...
        Node(
            ...
            parameters=[{
                ...
                'hover_z_a': LaunchConfiguration('hover_z_a'),
                'target_z_a': LaunchConfiguration('target_z_a'),
                'hover_z_d': LaunchConfiguration('hover_z_d'),
                'target_z_d': LaunchConfiguration('target_z_d'),
